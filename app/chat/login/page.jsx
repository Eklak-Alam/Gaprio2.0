  ...
  return (
    <div className="min-h-screen flex bg-gray-900 text-white relative overflow-hidden">
      ...
      <motion.div
        ...
        className="hidden lg:flex w-1/2 flex-col items-center justify-center p-12 pt-32 relative"
      >
        {/* Logo */}
         <motion.div
           initial={{ scale: 0.8 }}
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 pt-36">
        <motion.div
