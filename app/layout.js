...
export const metadata = {
  ...
  description: "Gaprio harnesses advanced AI to understand, interpret, and bridge communication gaps, fostering clarity, empathy, and genuine human connection.",
  metadataBase: new URL("https://www.gaprio.com"), // Replace with your actual domain
  openGraph: {
    title: "Gaprio | AI-Powered Mediator for Human Gaps",
    description: "Fostering clarity, empathy, and genuine human connection with advanced AI.",
...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <body className="bg-gray-900"> {/* Set bg here to avoid flashes */}
        <ApiProvider>
          <SmoothScroll> {/* Wrap children with the smooth scroll component */}
            <Navbar />
            {children}
            <Footer />
            {/* <DemoNotification /> */}
