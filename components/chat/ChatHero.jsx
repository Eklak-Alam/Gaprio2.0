    ...
    <section className="relative overflow-hidden pt-10 bg-gray-900 text-white">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24 pt-24 md:py-32 text-center">
        ...
        >
          ...
          <span className="text-sm font-medium text-gray-300">Revolutionizing Group Chats</span>
        </motion.div>
        ...
        >
          <span className="block text-white drop-shadow-[0_0_15px_rgba(139,92,246,0.7)]">Multi-User</span>
          <span className={textGradient}>AI Chat Experience</span>
        </motion.h1>
        ...
        >
          The first AI chatbot that understands group dynamics. Seamlessly participate in 
          multi-user conversations, maintain context across all participants, and provide 
          intelligent assistance when needed — bridging humans and AI like never before.
        </motion.p>
        ...
        >
          <Link href='/' className={`${primaryGradient} hover:from-indigo-600 hover:to-purple-700 cursor-pointer text-white font-medium py-3 px-6 rounded-lg transition-all duration-300 flex items-center justify-center shadow-lg hover:shadow-xl`}>
            Start Chatting <FiArrowRight className="ml-2 transition-transform group-hover:translate-x-1" />
          </Link>
